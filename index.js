...
const elements = document.getElementsByClassName('projects__title')
const elements__vids = document.getElementsByClassName('projects__preview')
...
arrayOfElements.forEach(el => {
    el.addEventListener('mouseenter', () => {
        ...
        el.addEventListener('mouseleave', () => {
            el.style.backgroundColor = 'rgb(255, 166, 0)'
        })
})
